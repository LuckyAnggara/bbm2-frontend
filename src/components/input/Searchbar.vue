<template>
  <div @mouseleave="showResult = false" class="w-full">
    ...
    <div
      class="absolute z-40 w-96"
      :class="[showResult == true ? '' : 'hidden', topPosition, leftPosition]"
    >
      <div class="h-fit w-full">
        <ul
          class="relative bg-white dark:bg-gray-700 rounded-md shadow-lg h-full w-full p-4 space-y-2"
        >
          ...
          <template v-else>
            <li
              ...
              class="group/text px-2 py-3 rounded-md dark:text-white text-center"
            >
              <span> Tidak adsdaasdasa data </span>
            </li>
            <li
              v-else
    ...
    <div
      ...
      class="min-h-fit max-h-96 w-full border-t-2 mt-6 py-2 dark:border-gray-700 border-gray-200 overflow-y-auto"
    >
