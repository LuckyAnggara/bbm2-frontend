<template>
  <div @mouseenter="disabledAdd == true ? '' : (showResult = true)" class="w-96 space-y-4 relative">
    <form class="flex items-center" autocomplete="off" @submit.prevent>
      ...
      <div class="relative w-full">
        ...
        <input
          ...
          type="text"
          :class="disabledAdd ? 'bg-gray-200 dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-700'"
  ...
  <div @mouseleave="showResult = false" class="absolute z-500 w-4/6" :class="[showResult == true ? '' : 'hidden', topPosition, leftPosition]">
...
defineProps(['modelValue', 'isLoading', 'resultItems', 'placeholder', 'topPosition', 'leftPosition', 'disabledAdd'])
