<template>
    ...
    <div class="flex space-x-4">
      <div v-if="useSearch == true" class="relative">
        ...
        <input
          ...
          type="text"
          class="shadow-md block p-2.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
  ...
  >
    <table class="w-full text-sm text-left">
      ...
      <tbody class="bg-white dark:bg-gray-800 text-black dark:text-gray-400">
        <tr v-if="isLoading">
