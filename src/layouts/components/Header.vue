      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{{ authStore.userData?.branch.name ?? '' }}</span>
          </a>
        </div>
          ...
          <div class="flex items-center ml-3 space-x-2">
            <div>
              <button
                @click="isDark = !isDark"
                type="button"
                class="text-gray-500 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-lg text-sm p-2.5"
              >
