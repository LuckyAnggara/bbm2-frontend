          ...
          <div class="flex items-center ml-3 space-x-2">
            <div>
              <button
                @click="isDark = !isDark"
                type="button"
                class="text-gray-500 dark:text-gray-400 hover:bg-green-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
              >
                <svg
                  v-if="!isDark"
                  class="w-5 h-5"
