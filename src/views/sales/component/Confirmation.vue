          ...
          <ul class="">
            <li class="px-6 mb">
              ...
              >
                ...
                <span
                  class="text-xl font-normal cursor-pointer break-words flex-wrap w-2/3 text-right"
            ...
            <li class="px-6 mb">
              <div
                class="pt-3 dark:text-white text-black flex justify-between flex-row font-thin"
              >
                <span class="text-md w-1/3">Alamat</span>
                <span
                  class="text-base font-normal cursor-pointer break-words flex-wrap w-2/3 text-right"
                  @click="showModal = true"
            ...
            <li class="px-6 mb">
              <div
                class="border-b-2 dark:border-gray-600 border-gray-400 pt-3 pb-4 dark:text-white text-black flex justify-between flex-row font-thin"
              >
