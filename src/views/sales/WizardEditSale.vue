<template>
  <div class="xl:pr-12">
    <template v-if="salesStore.singleResponses">
      <ol
        class="flex cursor-pointer items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base"
      >
        <li
          @click="step = 1"
          :class="[
        ...
        <li
          @click="step = 4"
          :class="[step == 4 ? 'text-blue-600 dark:text-blue-500' : 'cursor-pointer']"
