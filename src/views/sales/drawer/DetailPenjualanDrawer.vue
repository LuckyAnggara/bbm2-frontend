<template>
  <div
    ...
    class="py-20 top-0 right-0 z-40 w-full h-screen absolute max-w-xs p-4 overflow-y-auto transition-transform duration-500 ease-in-out bg-white dark:bg-gray-800 shadow-md"
  >
    <div class="px-2">
