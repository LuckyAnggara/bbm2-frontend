<template>
  <div>
    <template v-if="salesStore.showDrawerData">
      ...
      <div class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Nama Pelanggan</label>
        <input
      ...
      <div class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Nomor Telepon</label>
        <input
      ...
      <div class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Alamat</label>
        <textarea
      ...
      <div class="mb-2" v-if="salesStore.showDrawerData.shipping_type == 'DELIVERY'">
      ...
      <div class="flex flex-col space-y-4 mb-2">
        <div>
          <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Delivery Status</label>
          <div
            :class="
        ...
        <small
          v-if="salesStore.showDrawerData.shipping_type == 'DELIVERY' && _isEmpty(shippingDetailStore.responses)"
        ...
        <div v-if="!_isEmpty(shippingDetailStore.responses)" class="border-t-2 border-b-2">
          <div class="mb-2">
            <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Nama Penerima</label>
            <input
          ...
          <div class="mb-2">
            <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Kelurahan</label>
            <input
          ...
          <div class="mb-2">
            <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Kecamatan</label>
            <input
          ...
          <div class="mb-2">
            <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Kota</label>
            <input
          ...
          <div class="mb-2">
            <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Kode Pos</label>
            <input
      ...
      <div v-if="salesStore.showDrawerData.credit == true" class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Total Pembayaran</label>
        <input
      ...
      <div v-if="salesStore.showDrawerData.credit == true" class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Sisa Kredit</label>
        <input
      ...
      <div v-if="salesStore.showDrawerData.credit == true" class="mb-2">
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Jatuh Tempo</label>
        <input
      ...
      <div>
        <label class="block mb-2 font-medium text-gray-900 dark:text-white text-sm">Payment Status</label>
        <div
