          ...
          >
            ...
            >
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                Metode downPayment Credit / Kredit / Tempo
              </h3>
              <button
                @click="closeModal"
                type="button"
            ...
            <div class="flex flex-col space-y-6">
              ...
              <div class="flex items-center justify-between">
                <label
                  for="description"
                  class="block mb-2 text-2xl font-medium text-gray-900 dark:text-white w-2/3"
                  >Sisa Pembayaran</label
                >
                <span
                  class="text-3xl dark:text-red-500 text-red-500 font-semibold"
                  >{{ IDRCurrency.format(sisaPembayaran ?? 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <label
                ...
                <div class="w-2/5">
                  <vue-tailwind-datepicker
                    ...
                    as-single
                    input-classes="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full py-2.5 px-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                </div>
              </div>
...
const sisaPembayaran = computed(() => {
  return (
    salesStore.currentData.total.total - salesStore.currentData.credit.amount
  )
})
...
function closeModal() {
  salesStore.currentData.credit.amount = 0
  emit('close')
}
</script>
