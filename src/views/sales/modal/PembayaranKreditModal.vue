        ...
        >
          ...
          <form @submit.prevent="emit('submitTransaction', payment)">
            ...
            <button
              :class="
                canSubmit
                  ? 'hover:translate-x-2 duration-300 ease-in-out bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                  : 'bg-red-700 dark:bg-red-700'
              "
              :disabled="!canSubmit"
              class="text-white inline-flex items-center font-medium rounded-lg text-sm px-5 py-2 text-center"
            >
              <svg
