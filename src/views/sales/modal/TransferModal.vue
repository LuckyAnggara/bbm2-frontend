        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
          ...
          <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Metode Pembayaran Transfer</h3>
              <button
                @click="closeModal"
                type="button"
              ...
              <div>
                ...
                <div class="flex flex-row space-x-2">
                  <div class="w-full">
                    ...
                    >
                      <option v-for="item in bankStore.items" :key="item.id" :value="item">
                  ...
                  >
                    <ArrowPathIcon :class="bankStore.isLoading ? 'animate-spin' : ''" class="h-5 w-5" />
