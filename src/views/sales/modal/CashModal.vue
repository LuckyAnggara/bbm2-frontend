          ...
          >
            ...
            <div class="flex flex-col space-y-6">
              ...
              <div class="sm:col-span-2">
                ...
                <!-- <input
                ref="inputRef"
                v-model.number="pembayaran"
                type="number"
                class="block p-2.5 w-full text-2xl bg-gray-50 dark:bg-gray-700 text-gray-900 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Input uang oleh customer"
              /> -->
              </div>
              <div class="flex items-center justify-between">
                <label
