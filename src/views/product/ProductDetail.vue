        ...
        <TabPanels class="mt-2 w-full bg-white py-4 px-6 rounded-md dark:bg-gray-800 dark:text-white shadow-sm">
          <div class="text-2xl font-medium mb-4 flex flex-row justify-between">
            <span class="py-2"
              ...
              <span class="text-xs text-green-500 transition-all duration-300" v-if="isEdit">(Edit Mode)</span></span
            >
                  ...
                  <div class="sm:col-span-2">
                    ...
                    >
                      <select
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      >
                        <option value="0" readonly>Pilih satuan product</option>
          ...
          <TabPanel>
            <div class="flex flex-col md:flex-row md:space-x-8 md:divide-x-2">
              ...
              <div class="md:w-2/3 min-w-md md:px-6">
                <div
                ...
                <div v-if="stateShow == 'buy'" class="mt-4"></div>
              </div>
            </div>
          </TabPanel>
          <TabPanel>
