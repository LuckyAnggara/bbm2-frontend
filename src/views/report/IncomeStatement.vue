    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400 table-fixed">
        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400 text-center">
          ...
          <tr>
            <th scope="col" class="px-4 py-3 W-12 border border-slate-400 dark:border-slate-600">{{ moment().format('DD MMMM YY') }}</th>
            <th scope="col" class="px-4 py-3 W-12 border border-slate-400 dark:border-slate-600">{{ moment().subtract(1, 'days').format('DD MMMM YY') }}</th>
